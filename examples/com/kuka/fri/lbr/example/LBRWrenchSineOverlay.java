...
/**
 * Implementation of a FRI example application to demonstrate how to use a joint overlay with wrench control mode.
 * <p>
 * Moves the LBR in a start position, creates an FRI-Session and executes a PositionHold motion with FRI joint overlay.
 * During this motion joint angles and wrenches can be additionally commanded via FRI
 * (see LBRWrenchSineOverlayClient).
 */
public class LBRWrenchSineOverlay extends RoboticsAPIApplication
{
    ...
    public void run()
    {
        ...
        IFriJointOverlay wrenchOverlay = friCommanding.createJointOverlay(_friSession, EClientCommandMode.WRENCH);
