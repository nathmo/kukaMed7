package fri.lbr.sdk.example.lbrTorqueSineOverlay;
...
import com.kuka.fri.lbr.clientsdk.clientLBR.LBRState;

/**
 * Example client that superposes joint torques of the robot with sine waves.
 */
public class LBRTorqueSineOverlayClient extends LBRClient
{
    ...
    public void waitForCommand()
    {
        ...
        if (getRobotState().getClientCommandMode() == EClientCommandMode.TORQUE)
        {
