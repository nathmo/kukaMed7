...
import com.kuka.fri.api.monitoring.EFriSessionState;
import com.kuka.fri.lbr.clientsdk.clientLBR.LBRClient;

/**
 * Example client that can add additional forces along the X and Y direction of the tool center point of the LBR. The
 * forces change their amplitude sinusoidally.
 */
public class LBRWrenchSineOverlayClient extends LBRClient
{
    ...
    @Override
    public void onStateChange(EFriSessionState oldState, EFriSessionState newState)
    {
        switch (newState)
        {
    ...
    public void waitForCommand()
    {
        ...
        // value into account.
        if (getRobotState().getClientCommandMode() == EClientCommandMode.WRENCH)
        {
